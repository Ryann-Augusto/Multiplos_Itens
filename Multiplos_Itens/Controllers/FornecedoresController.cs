...
namespace Multiplos_Itens.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public FornecedoresController(_DbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Fornecedor != null ? 
                          ...
                          Problem("Entity set '_DbContext.Fornecedor'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Fornecedor fornecedor)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set '_DbContext.Fornecedor'  is null.");
            }
            var fornecedor = await _context.Fornecedor.FindAsync(id);
            if (fornecedor != null)
            {
